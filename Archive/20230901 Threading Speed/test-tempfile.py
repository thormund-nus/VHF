"""Here, we test writing to a NAS through the use of a tempfile.
33.55s sampling takes 14.07s to write after the tempfile has finished collecting the buffer.
"""
